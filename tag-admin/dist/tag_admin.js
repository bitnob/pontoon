...
const TagResourceSearch = _ref => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    value: "assoc"
  }, "Linked"), /*#__PURE__*/React.createElement("option", {
    value: "nonassoc"
  }, "Not linked")))));
};
...
function isSameOrigin(url) {
  ...
  return parsedURL === domain || parsedURL === origin || !/^(\/\/|http:|https:).*/.test(parsedURL);
}
...
function normalizeComponent(Comp, props) {
  ...
  if (reactIsExports.isElement(Comp) || typeof Comp === 'string') {
    return Comp;
  } else if (reactIsExports.isValidElementType(Comp)) {
  ...
  return function (_Base) {
    ...
    _createClass$2(_class, [{
      ...
      value: function getResolvedState(props, state) {
        var resolvedState = _extends$4({}, _.compactObject(this.state), _.compactObject(this.props), _.compactObject(state), _.compactObject(props));
      ...
      value: function getDataModel(newState, dataChanged) {
        ...
        var makeDecoratedColumn = function makeDecoratedColumn(column, parentColumn) {
          var dcol = void 0;
          if (column.expander) {
            dcol = _extends$4({}, _this2.props.column, _this2.props.expanderDefaults, column);
          } else {
            dcol = _extends$4({}, _this2.props.column, column);
          }
        ...
        if (pivotBy.length) {
          ...
          var pivotColumnGroup = {
            ...
            columns: pivotColumns.map(function (col) {
              return _extends$4({}, _this2.props.pivotDefaults, col, {
                pivoted: true
              });
            })
          ...
          if (pivotIndex >= 0) {
            pivotColumnGroup = _extends$4({}, visibleColumns[pivotIndex], pivotColumnGroup);
        ...
        var addHeader = function addHeader(columns, column) {
          headerGroups.push(_extends$4({}, _this2.props.column, column, {
            columns: columns
          }));
          currentSpan = [];
        };
        ...
        if (pivotBy.length) {
          var groupRecursively = function groupRecursively(rows, keys) {
            ...
            groupedRows = groupedRows.map(function (rowGroup) {
              ...
              return _extends$4({}, rowGroup, (_extends2 = {}, _defineProperty(_extends2, subRowsKey, subRows), _defineProperty(_extends2, aggregatedKey, true), _extends2), aggregate(subRows));
            });
            return groupedRows;
          };
      ...
      value: function fireFetchData() {
        ...
        var currentState = _extends$4({}, this.getResolvedState(), {
      ...
      value: function filterData(data, filtered, defaultFilterMethod, allVisibleColumns) {
        ...
        if (filtered.length) {
          ...
          filteredData = filteredData.map(function (row) {
            ...
            return _extends$4({}, row, _defineProperty({}, _this3.props.subRowsKey, _this3.filterData(row[_this3.props.subRowsKey], filtered, defaultFilterMethod, allVisibleColumns)));
          }).filter(function (row) {
            if (!row[_this3.props.subRowsKey]) {
              return true;
            }
...
var ReactTable = function (_Methods) {
    ...
    value: function render() {
      ...
      var recurseRowsViewIndex = function recurseRowsViewIndex(rows) {
        ...
        return [rows.map(function (row, i) {
          index += 1;
          var rowWithViewIndex = _extends$1({}, row, {
            _viewIndex: index
          });
      ...
      var rowIndex = -1;
      var finalState = _extends$1({}, resolvedState, {
        startRow: startRow,
        endRow: endRow,
        pageRows: pageRows,
        minRows: minRows,
      ...
      var makeHeaderGroup = function makeHeaderGroup(column, i) {
        ...
        var styles = _extends$1({}, column.headerStyle, theadGroupThProps.style, columnHeaderProps.style);
        var rest = _extends$1({}, theadGroupThProps.rest, columnHeaderProps.rest);
        var flexStyles = {
          flex: flex + ' 0 auto',
          width: _.asPx(width),
          maxWidth: _.asPx(maxWidth)
        };
        return /*#__PURE__*/React.createElement(ThComponent, _extends$1({
          key: i + '-' + column.id,
          className: classnames(classes),
          style: _extends$1({}, styles, flexStyles)
      ...
      var makeHeaderGroups = function makeHeaderGroups() {
        ...
        return /*#__PURE__*/React.createElement(TheadComponent, _extends$1({
          className: classnames('-headerGroups', theadGroupProps.className),
          style: _extends$1({}, theadGroupProps.style, {
            minWidth: rowMinWidth + 'px'
          })
        }, theadGroupProps.rest), /*#__PURE__*/React.createElement(TrComponent, _extends$1({
      ...
      var makeHeader = function makeHeader(column, i) {
        ...
        var styles = _extends$1({}, column.headerStyle, theadThProps.style, columnHeaderProps.style);
        var rest = _extends$1({}, theadThProps.rest, columnHeaderProps.rest);
        var isResizable = _.getFirstDefined(column.resizable, resizable, false);
        var resizer = isResizable ? /*#__PURE__*/React.createElement(ResizerComponent, _extends$1({
      ...
      var makeHeaders = function makeHeaders() {
        ...
        return /*#__PURE__*/React.createElement(TheadComponent, _extends$1({
          ...
          style: _extends$1({}, theadProps.style, {
            minWidth: rowMinWidth + 'px'
          })
        }, theadProps.rest), /*#__PURE__*/React.createElement(TrComponent, _extends$1({
      ...
      var makeFilter = function makeFilter(column, i) {
        ...
        var styles = _extends$1({}, column.headerStyle, theadFilterThProps.style, columnHeaderProps.style);
        var rest = _extends$1({}, theadFilterThProps.rest, columnHeaderProps.rest);
      ...
      var makeFilters = function makeFilters() {
        ...
        return /*#__PURE__*/React.createElement(TheadComponent, _extends$1({
          ...
          style: _extends$1({}, theadFilterProps.style, {
            minWidth: rowMinWidth + 'px'
          })
        }, theadFilterProps.rest), /*#__PURE__*/React.createElement(TrComponent, _extends$1({
      ...
      var makePageRow = function makePageRow(row, i) {
        ...
        return /*#__PURE__*/React.createElement(TrGroupComponent, _extends$1({
          key: rowInfo.nestingPath.join('_')
        }, trGroupProps), /*#__PURE__*/React.createElement(TrComponent, _extends$1({
          ...
          var styles = _extends$1({}, tdProps.style, column.style, columnProps.style);
          var cellInfo = _extends$1({}, rowInfo, {
            isExpanded: isExpanded,
            column: _extends$1({}, column),
          ...
          if (cellInfo.pivoted) {
            ...
            if (isBranch) {
              // isPivot
              resolvedCell = _.normalizeComponent(ResolvedPivotComponent, _extends$1({}, cellInfo, {
          ...
          // Return the cell
          return /*#__PURE__*/React.createElement(TdComponent
          // eslint-disable-next-line react/no-array-index-key
          , _extends$1({
            key: i2 + '-' + column.id,
      ...
      var makePadColumn = function makePadColumn(column, i) {
        ...
        var classes = [tdProps.className, column.className, columnProps.className];
        var styles = _extends$1({}, tdProps.style, column.style, columnProps.style);
        return /*#__PURE__*/React.createElement(TdComponent, _extends$1({
          key: i + '-' + column.id,
      ...
      var makeColumnFooter = function makeColumnFooter(column, i) {
        ...
        var styles = _extends$1({}, tFootTdProps.style, column.style, columnProps.style, columnFooterProps.style);
        return /*#__PURE__*/React.createElement(TdComponent, _extends$1({
          key: i + '-' + column.id,
          className: classnames(classes, !show && 'hidden'),
          style: _extends$1({}, styles, {
      ...
      var makeColumnFooters = function makeColumnFooters() {
        ...
        return /*#__PURE__*/React.createElement(TfootComponent, _extends$1({
          className: tFootProps.className,
          style: _extends$1({}, tFootProps.style, {
            minWidth: rowMinWidth + 'px'
          })
        }, tFootProps.rest), /*#__PURE__*/React.createElement(TrComponent, _extends$1({
      ...
      var makePagination = function makePagination(isTop) {
        ...
        return /*#__PURE__*/React.createElement(PaginationComponent, _extends$1({}, resolvedState, {
          pages: pages,
          canPrevious: canPrevious,
          canNext: canNext,
      ...
      var makeTable = function makeTable() {
        return /*#__PURE__*/React.createElement('div', _extends$1({
          ...
          style: _extends$1({}, style, rootProps.style)
        }, rootProps.rest), showPagination && showPaginationTop ? /*#__PURE__*/React.createElement('div', {
          className: 'pagination-top'
        }, makePagination(true)) : null, /*#__PURE__*/React.createElement(TableComponent, _extends$1({
          className: classnames(tableProps.className, currentlyResizing ? 'rt-resizing' : ''),
          style: tableProps.style
        }, tableProps.rest), hasHeaderGroups ? makeHeaderGroups() : null, makeHeaders(), hasFilters ? makeFilters() : null, /*#__PURE__*/React.createElement(TbodyComponent, _extends$1({
          className: classnames(tBodyProps.className),
          style: _extends$1({}, tBodyProps.style, {
            minWidth: rowMinWidth + 'px'
          })
        ...
        }, makePagination(false)) : null, !pageRows.length && /*#__PURE__*/React.createElement(NoDataComponent, noDataProps, _.normalizeComponent(noDataText)), /*#__PURE__*/React.createElement(LoadingComponent, _extends$1({
          loading: loading,
  ...
  return ReactTable;
}(Methods(Lifecycle(reactExports.Component)));
...
const prune = (checked, visible) => new Set([...checked].filter(v => visible.includes(v)));
function CheckboxTable(_ref) {
  let {
    data,
    onSubmit,
    submitMessage
  } = _ref;
  const visible = reactExports.useRef([]);
  const [checked, setChecked] = reactExports.useState(new Set());
  const clearChecked = () => setChecked(new Set());
  const pruneChecked = () => setChecked(checked => prune(checked, visible.current));
  reactExports.useEffect(() => {
  ...
  const selectOne = reactExports.useCallback(_ref2 => {
    let {
      target
    } = _ref2;
    setChecked(checked => {
  ...
  const columns = [{
    ...
    Header: 'Resource',
    id: 'type',
    Cell: item => /*#__PURE__*/React.createElement("span", null, item.original[0])
  }];
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ReactTable, {
    defaultPageSize: 5,
...
function ErrorList(_ref) {
  ...
  return entries.length === 0 ? null : /*#__PURE__*/React.createElement("ul", {
    className: "errors"
  }, entries.map((_ref2, index) => {
...
function TagResourceManager(_ref) {
  let {
    api
  } = _ref;
  const [data, setData] = reactExports.useState([]);
  const [errors, setErrors] = reactExports.useState({});
  const [type, setType] = reactExports.useState('assoc');
  const [search, setSearch] = reactExports.useState('');
  const handleChange = reactExports.useCallback(async params => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "tag-resource-widget"
  }, /*#__PURE__*/React.createElement(TagResourceSearch, {
    onSearch: setSearch,
    onType: setType
  }), /*#__PURE__*/React.createElement(ErrorList, {
    errors: errors
  }), /*#__PURE__*/React.createElement(CheckboxTable, {
    data: data,
    onSubmit: _ref2 => {
      let {
        data
...
function TagResourcesButton(props) {
  const [open, setOpen] = reactExports.useState(false);
  const message = open ? 'Hide the resource manager for this tag' : 'Manage resources for this tag';
  const toggle = ev => {
    ev.preventDefault();
    setOpen(open => !open);
  };
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("button", {
    onClick: toggle
  }, message), open ? /*#__PURE__*/React.createElement(TagResourceManager, props) : null);
}
...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('.js-tag-resources').forEach(node => {
    ...
    ReactDOM.render( /*#__PURE__*/React.createElement(TagResourcesButton, {
      api: api,
      project: project,
      tag: tag
    }), node);
